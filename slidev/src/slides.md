...
<div v-click mt-12>
Is it complete? User-friendly, bullet proof, bug free? <tt>No</tt>.
Is it already usable today? Definitely <tt>YES</tt>.
</div>
...
<ul>
   <li>Sli.dev already has an MCP server OOB</li>
...
<div v-click mt-12>
Imagine something like: "update slide 4, 8 and 10 of the microcloud enablement course with the new 3.3 release. Regenerate terminal output in slide 2 to show the new version release"
</div>
