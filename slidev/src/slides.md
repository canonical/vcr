...
<ul>
   <li>Need to record <tt>terminal</tt> sessions</li>
   <li>Need to record <tt>web</tt> sessions with UI</li>
   <li>Need to be in <tt>different</tt> languages (slides/speech)</li>
   <li>Some modules may be present in <tt>different</tt> enablement courses</li>
   <li>Recording a course is time consuming, so cost is <tt>very high</tt></li>
   <li>Current courses are often recorded live sessions, <tt>not studio-quality</tt></li>
</ul>
...
<ul>
   ...
   <li>Refactoring of some crappy AI-generated code</li>
   <li>Integration of the Speech/subtitles part (which is now "external")</li>
...
<div v-click mt-12>
Is VCR already usable today? Definitely <tt>YES</tt>.
</div>
...
<ul>
   <li>Sli.dev already has an MCP server OOB, it works pretty well</li>
   <li>The plan is to extend the MCP server with the new capabilities (Terminal, Web session, Speech)</li>
   <li>Most of the slides can be easily generated by an LLM</li>
</ul>
